...
$pdf->startReport('Reporte de productos por estado',);
...
if ($dataproducto = $producto->reporEstado()) {
    ...
    $pdf->cell(95, 10, utf8_decode('Estado Actual'), 1, 1, 'C', 1);

    ...
    if (isset($_SESSION['id_usuario'])) {
        ...
        switch ($_GET['action']) {
            ...
            case 'create':
                ...
                if (!$producto->setNombreProducto($_POST['nombre'])) {
                ...
                } elseif (!$producto->setCantidadProducto($_POST['cantidad'])) {
                    $result['exception'] = 'Cantidad no disponible';
                }elseif (!$producto->setDescripcionProducto($_POST['descripcion'])) {
                    ...
                    $result['status'] = 1;
                    $result['message'] = 'Producto agregado correctamentente';
                } else {
                    $result['exception'] = Database::getException();;
                }
                break;
